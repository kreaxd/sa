...
module.exports.operate = async ({client, msg, args, author, auth}, {MessageEmbed} = require("discord.js")) => {
    ...
    if (Sayi[author.id].kullanim >= 3) return client.message(client.embed(`${client.react("iptal")} | Bir gün içinde maximum 3 kere ismin değiştirebilirsin.`, msg), msg.channel.id, 6500);
